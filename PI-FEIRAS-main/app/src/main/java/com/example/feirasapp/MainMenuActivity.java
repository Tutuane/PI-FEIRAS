...
public class MainMenuActivity extends AppCompatActivity {
    ...
    public void fale(View v){
        Intent i = new Intent( MainMenuActivity.this, FaleConoscoActivity.class);
        startActivity(i);
    }
    public void planos(View v){
        Intent i = new Intent( MainMenuActivity.this, PlanosActivity.class);
        startActivity(i);
    }
    ...
    public void produtos(View v){
        Intent i = new Intent( MainMenuActivity.this, ListaProdutosActivity.class);
        startActivity(i);
    }
    public void sobre(View v){
        Intent i = new Intent( MainMenuActivity.this, SobreNosActivity.class);
        startActivity(i);
    }
